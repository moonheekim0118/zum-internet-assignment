...
function StarIcon({ theme }: IProps): string {
  return `
    <svg class="star-svg ${theme}" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/2000/xlink" width="21px" height="20px">
